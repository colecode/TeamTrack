          ...
          <div className={'my-container'}>
            ...
            <form role="form">
              ...
              <div style={submitBtnStyle}>
                <Button bsStyle="primary" bsSize="large" block onClick={this.handleSubmit}>Create Runner</Button>
              </div>
              <div style={nextBtnStyle}>
                <Button bsStyle="success" bsSize="large" block href="#createteam">Next</Button>
              </div>
            </form>       
            </div>          
          </div>
