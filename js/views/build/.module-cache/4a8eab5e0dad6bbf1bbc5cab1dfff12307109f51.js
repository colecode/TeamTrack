  ...
  'reactboot'
    ...
    var DropdownContainer = React.createClass({displayName: 'DropdownContainer',
      ...
      render: function() {
        ...
        //var myMenuItem = <MenuItem onSelect={goToTest}>Alaska</MenuItem>
        ...
        this.props.dmnArray.map(function(domainVal, i) {
          rows.push(React.createElement(MenuItem, {onSelect: goToTest, key: i}, domainVal.description))
        });
