    ...
    var SearchBar = React.createClass({displayName: 'SearchBar',
      ...
      render: function() {
        ...
        return (
            ...
            React.createElement("div", {className: 'input-groud'}, 
              React.createElement("input", {type: "text", className: "form-control", placeholder: "Search"}), 
              React.createElement("button", {type: "submit", className: "btn input-group-addon"}, React.createElement("i", {className: "glyphicon glyphicon-search"}))
            )
            )
          )
      }
