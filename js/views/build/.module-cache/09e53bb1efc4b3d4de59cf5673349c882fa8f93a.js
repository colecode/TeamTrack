  ...
  'reactboot'
    ...
    var DropdownContainer = React.createClass({displayName: 'DropdownContainer',
      ...
      render: function() {
        ...
        var myMenuItem = React.createElement(MenuItem, {onSelect: goToTest(this)}, "Alaska")
        ...
        this.props.dmnArray.map(function(domainVal, i) {
          rows.push(React.createElement(MenuItem, {onSelect: goToTest(this), key: i}, domainVal.description))
        });
