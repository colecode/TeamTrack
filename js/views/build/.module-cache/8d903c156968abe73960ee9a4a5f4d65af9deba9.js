  ...
  'reactboot'
    ...
    var DropdownContainer = React.createClass({displayName: 'DropdownContainer',
      ...
      render: function() {
        ...
        function selectedDomainVal(domainID) {
          var test = myParent;
        ...
        this.props.dmnArray.map(function(domainVal, i) {
          rows.push(React.createElement(MenuItem, {onSelect: selectedDomainVal(domainVal.id), key: domainVal.id}, domainVal.description))
        });
