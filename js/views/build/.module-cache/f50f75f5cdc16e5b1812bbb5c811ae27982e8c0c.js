          ...
          React.createElement("div", {className: 'my-container'}, 
            ...
            React.createElement("form", {role: "form"}, 
              ...
              React.createElement("div", {className: "form-group"}, 
                ...
                React.createElement(DropdownContainer, {allDomains: this.props.dmnArray_Schools})
              ), 
              React.createElement("div", {className: "form-group"}, 
                React.createElement("label", null, "State"), React.createElement("br", null), 
                React.createElement(DropdownContainer, {allDomains: this.props.dmnArray_States})
              ), 
...
//               <input type="text" className={"form-control"} value={this.props.schoolName} onChange={this.onSchoolNameChange} />
    ...
    var CreateRunnerView = Backbone.View.extend({
      ...
      initialize: function() {  
        ...
        dmnArray_States = ['Alaska','New Hampshire'];
