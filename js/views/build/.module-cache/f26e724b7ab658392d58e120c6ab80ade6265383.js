        ...
        return (
          React.createElement("div", null, 
            React.createElement("div", {className: 'wrap'}, 
              React.createElement(CreateTeam, {onSchoolSelect: this.handleSchoolSelect, schoolName: this.state.schoolName}), 
              React.createElement(SimpleRunnersTable, {selectedRunners: this.state.selectedRunners, allRunners: this.state.allRunners}), 
              React.createElement(CreateRunner, {schoolCode: this.state.schoolCode, onUpdate: this.handleCreateRunner}), 
