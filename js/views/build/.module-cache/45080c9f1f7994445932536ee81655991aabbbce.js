          ...
          React.createElement("div", {className: 'my-container'}, 
            ...
            React.createElement("form", {role: "form"}, 
              React.createElement("div", {className: "form-group"}, 
                ...
                React.createElement("input", {type: "text", className: "form-control", valueLink1: this.linkState(this.props.firstName)})
              ), 
              React.createElement("div", {className: "form-group"}, 
                React.createElement("label", null, "Last name"), 
                React.createElement("input", {type: "text", className: "form-control", valueLink2: this.linkState(this.props.lastName)})
              ), 
              React.createElement("div", {className: "form-group"}, 
                React.createElement("label", null, "School"), 
                React.createElement("input", {type: "text", className: "form-control", valueLink3: this.linkState(this.props.schoolName)})
              ), 
              React.createElement("div", {className: "form-group"}, 
