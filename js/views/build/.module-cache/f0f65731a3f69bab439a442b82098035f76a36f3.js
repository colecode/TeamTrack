  ...
  'reactboot'
    ...
    var DropdownContainer = React.createClass({displayName: 'DropdownContainer',
      ...
      render: function() {
        ...
        var myMenuItem = React.createElement(MenuItem, {ref: "myMenu", onSelect: this.handleMenuSelect}, "Alaska")
        ...
        this.props.dmnArray.map(function(domainVal, i) {
          rows.push(React.createElement(MenuItem, {myHandler: true, onSelect: goToHash('action'), key: i}, domainVal.description))
        });
        ...
        return (    
           ...
           React.createElement(DropdownButton, {ref: "DropMenu", bsStyle: "primary", title: this.props.menuTitle, style: {width : 200}, onSelect: 
            function() 
            {
              var test=this;
            }}, 
