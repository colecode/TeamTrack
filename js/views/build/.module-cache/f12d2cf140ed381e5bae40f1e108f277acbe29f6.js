      ...
      render: function() {
        ...
        React.createElement("div", {className: 'form-box-wrap'}, 
          ...
          React.createElement("div", {className: 'input-group form-field-sizes'}, 
            React.createElement("input", {className: 'form-control', type: "text", placeholder: "School"})
          ), 
          React.createElement("div", {className: 'input-group form-field-sizes'}, 
            React.createElement("input", {className: 'form-control', type: "text", placeholder: "State"})
          ), 
           React.createElement("div", {className: 'input-group form-field-sizes'}, 
            React.createElement("button", {id: "saveteambtn", className: 'btn btn form-control'}, "Save")
          )
        )
