define(
  ...
  'views/build/dropdownContainer'
    ...
    var CreateRunnerMaster = React.createClass({displayName: 'CreateRunnerMaster',
      ...
      handleSelect_dmnSchools: function(domainVal) {
        this.setState({ schoolName: this.props.dmnArray_Schools[i].description });
      },

      handleSelect_dmnStates: function(domainVal) {
          ...
          React.createElement("div", {className: 'my-container'}, 
            ...
            React.createElement("form", {role: "form"}, 
              ...
              React.createElement("div", {className: "form-group"}, 
                ...
                React.createElement(DropdownContainer, {dmnArray: this.state.dmnArray_States, menuTitle: "Please select state", onStateSelect: this.handleSelect_dmnSchools})

              ), 
              React.createElement("div", {className: "form-group"}, 

                React.createElement("label", null, "School"), React.createElement("br", null), 
                React.createElement(DropdownContainer, {dmnArray: this.state.dmnArray_Schools, menuTitle: "Please select school"})
