define(
  ...
  'views/build/createTeamComponent'
  ], function($, _, Backbone, React, backboneMixin, CreateRunnerModel, ReactBoot, DropdownContainer, CreateTeamComponent){
          ...
          React.createElement("div", {className: 'my-container'}, 
            ...
            React.createElement("form", {role: "form"}, 
              ...
              React.createElement("div", {style: nextBtnStyle}, 
                React.createElement(Button, {bsStyle: "success", bsSize: "large", block: true, href: "#createrunner/5"}, "Next")
              )
            )
            )
          )
